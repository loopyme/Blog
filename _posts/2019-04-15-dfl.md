...
Deepfake技术用于将已有的图像或影片叠加至目标图像或影片上,俗称换头.

## 道德争议

道德层面上`DeepFakeLab`的存在和使用都存在争议,据我所知,它甚至使用在某些色情片中,关于互联网信息的真实性以及人们对`deepfake`的看法,[Toni Allen](https://www.whoishostingthis.com/authors/toni/)[@whoishostingthis](https://www.whoishostingthis.com/)进行了调查,并发表了名为["Dodging Deception & Seeking Truth Online \[Survey Results\]"](https://www.whoishostingthis.com/blog/2019/09/02/seeking-trust-online/)的文章,关于DeepFake的的调查结果如下图,对其感兴趣的可以去看一下原文章.
 
![1.png](https://www.whoishostingthis.com/wp-content/uploads/2019/09/seeking-trust-online-a4.webp)

> Data and image via <a href=”https://www.whoishostingthis.com/blog/2019/09/02/seeking-trust-online/”>WhoIsHostingThis</a>.

## 代码实现

抛开道德争议,我们继续关注技术.以下代码用于便携的在Colab上调用DFL项目的源码进行快捷方便的换脸

> Powered by [DeepFaceLab](https://github.com/iperov/DeepFaceLab)
